...
// File:  Henderson_A05_Q1.java
// Purpose: Complete implementation of ArrayStack class from Chapter 12

import java.util.Arrays;

public class Henderson_A05_Q1
{
    /**
    ...
    public static class ArrayStack<T> implements StackADT<T>
    {
         ...
         */
        // TH size() the current size is the value of top sinice top is
        // incremented on each push
        public int size()
        {
            // the current value of top is the number of items in the stack
            return top;
        }
        ...
        public String toString()
        {
            ...
            // for each value in the stack up to the value of top
            for(int i = 0; i < top; i++)
